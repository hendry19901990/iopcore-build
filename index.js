 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`iopcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`iopcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'iopcore-' + name : 'iopcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/iopcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external iopcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:iopcore-lib -o iopcore-lib.js';
    }
